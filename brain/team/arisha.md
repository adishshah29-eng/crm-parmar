...
**Owns:** Manager and sub_manager portal — team leads, reassignment, escalations, delegation

This file belongs to Arisha. Nobody else edits it. Everyone else reads it.

---

## Currently working on

_(one line — the task, and the branch name)_
